...
public class ImageUtils {
    ...
    public static void main(String[] args) {
        // 1-缩放图像：
        // 方法一：按比例缩放
        ImageUtils.scale("d:/user.jpg", "d:/abc_scale.jpg", 2, true);//测试OK
        // 方法二：按高度和宽度缩放
        ImageUtils.scale2("d:/user.jpg", "d:/abc_scale2.jpg", 500, 300, true);//测试OK


        // 2-切割图像：
        // 方法一：按指定起点坐标和宽高切割
        ImageUtils.cut("d:/user.jpg", "d:/abc_cut.jpg", 0, 0, 400, 400 );//测试OK
        // 方法二：指定切片的行数和列数
        ImageUtils.cut2("d:/user.jpg", "d:/", 2, 2 );//测试OK
        // 方法三：指定切片的宽度和高度
        ImageUtils.cut3("d:/user.jpg", "d:/", 300, 300 );//测试OK


        // 3-图像类型转换：
        ImageUtils.convert("d:/user.jpg", "GIF", "d:/abc_convert.gif");//测试OK


        // 4-彩色转黑白：
        ImageUtils.gray("d:/user.jpg", "d:/abc_gray.jpg");//测试OK
